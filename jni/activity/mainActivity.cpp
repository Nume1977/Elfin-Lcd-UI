...
static ZKButton* mButton_printPtr;
static ZKButton* mButton_configPtr;
static ZKButton* mButton_controlPtr;
...
static S_ButtonCallback sButtonCallbackTab[] = {
    ID_MAIN_Button_print, onButtonClick_Button_print,
    ID_MAIN_Button_config, onButtonClick_Button_config,
    ID_MAIN_Button_control, onButtonClick_Button_control,
};
/***************/
...
void mainActivity::onCreate() {
	Activity::onCreate();
    mButton_printPtr = (ZKButton*)findControlByID(ID_MAIN_Button_print);
    mButton_configPtr = (ZKButton*)findControlByID(ID_MAIN_Button_config);
    mButton_controlPtr = (ZKButton*)findControlByID(ID_MAIN_Button_control);
	mActivityPtr = this;
	onUI_init();
